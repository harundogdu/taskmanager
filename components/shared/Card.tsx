...
const Card = ({ card }: CardProps) => {
  ...
  return (
    <>
      <div
        onClick={toggleModal}
        className="bg-white flex text- flex-col p-2 shadow-xl hover:bg-gray-50 transition-colors rounded-lg border-b border-gray-100 mt-2 flex-shrink-0 cursor-pointer"
      >
      ...
      <CardDetailsModal card={card} isOpen={modalIsOpen} toggle={toggleModal} />
    </>
  );
};
